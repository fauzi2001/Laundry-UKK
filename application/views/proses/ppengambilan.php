   ...
   <?php if (!empty($this->session->flashdata('status'))): ?>
    ...
    <div class="row mt-3">
        ...
        <?php endforeach ?>
            ...
            <tr>
                <th>
                    <a href="<?php echo site_url('C_service/CProsesPengambilan/'.$d['id_transaksi']) ?>" class="btn btn-outline-success" onclick="return confirm('Yakin Barang Ingin Diambil')"> Konfirmasi </a>
                </th>
            </tr>
        </tbody>
        </table>
