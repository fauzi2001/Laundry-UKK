...
<body>
    ...
    <?php if ($this->session->has_userdata('username')) : ?>
        ...
        <?php
        foreach ($data as $d) : ?>
            <?= form_open('C_service/CProsesBayar/' . $d['id_transaksi'], ['method' => 'POST']) ?>
        <?php endforeach ?>
        <div class="container">
            <div class="row mt-3">
                <div class="col-md-3">
                ...
                <tbody>
                    ...
                    foreach ($data as $d) : ?>
                        <tr>
                            ...
                            <!--                 <td>
                        <a href="<?php echo site_url('C_service/CHapusKeranjang/' . $d['id_detail_transaksi']) ?>" class="btn btn-outline-success" onclick="return confirm('Yakin ingin menghapus')"> Hapus</a>
                </td> -->
                        </tr>
