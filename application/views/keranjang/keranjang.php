...
<body>
    ...
    <?php if ($this->session->has_userdata('username')) : ?>
                ...
                <tbody>
                    ...
                    foreach ($data as $d) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo site_url('C_service/CHapusKeranjang/' . $d['id_detail_transaksi']) ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus')"> Hapus</a>
                            </td>
                        </tr>
        ...
        <?= form_open('C_service/ProsesKeranjang', ['method' => 'POST']) ?>
        <div class="container">
            <hr>
            <div class="row mt-3">
                <div class="col-md-3">
